...
DEVENV "C\ApiHook\%__SolutionDir%\HookTest.sln" /rebuild "Release|Win32"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "C\InjectDll\%__SolutionDir%\InjectDll.sln" /rebuild "Release|Win32"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "C\TestDll\%__SolutionDir%\TestDll.sln" /rebuild "Release|Win32"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "CSharp\ApiAndMethodsHook\%__SolutionDir%\Test.sln" /rebuild "Debug|x86"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "CSharp\CreateProcessWithDllTest\%__SolutionDir%\CreateProcessWithDllTest.sln" /rebuild "Debug|x86"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
ENDLOCAL
...
DEVENV "C\ApiHook\%__SolutionDir%\HookTest.sln" /rebuild "Release|x64"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "C\InjectDll\%__SolutionDir%\InjectDll.sln" /rebuild "Release|x64"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "C\TestDll\%__SolutionDir%\TestDll.sln" /rebuild "Release|x64"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "CSharp\ApiAndMethodsHook\%__SolutionDir%\Test.sln" /rebuild "Debug|x64"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
DEVENV "CSharp\CreateProcessWithDllTest\%__SolutionDir%\CreateProcessWithDllTest.sln" /rebuild "Debug|x64"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
ENDLOCAL
