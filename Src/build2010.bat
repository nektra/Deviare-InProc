...
DEVENV vs2010\NktHookLib.sln /rebuild "Debug|Win32" /project "NktHookLib"
...
DEVENV vs2010\NktHookLib.sln /rebuild "Release|Win32" /project "DeviareLiteInterop" 
IF NOT %ERRORLEVEL% == 0 goto bad_compile
ENDLOCAL
...
DEVENV vs2010\NktHookLib.sln /rebuild "Debug|x64" /project "NktHookLib"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
REM DeviareLiteInterop depends on DeviareLiteCOM
REM DeviareLiteCOM depends on NktHookLib
DEVENV vs2010\NktHookLib.sln /rebuild "Release|x64" /project "DeviareLiteInterop"
IF NOT %ERRORLEVEL% == 0 goto bad_compile
ENDLOCAL
GOTO end
